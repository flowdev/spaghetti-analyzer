...
func TestRelativePackageName(t *testing.T) {
	givenRootPkg := "github.com/flowdev/spaghetti-analyzer"
	specs := []struct {
		name                 string
		givenPkgPath         string
		givenPkgName         string
	...
	}{
		{
			...
			name:                 "main-package",
			givenPkgPath:         "github.com/flowdev/spaghetti-analyzer",
			givenPkgName:         "main",
			expectedRelPkg:       "main",
			expectedStrictRelPkg: "/",
		}, {
			name:                 "root-package",
			givenPkgPath:         "github.com/flowdev/spaghetti-analyzer",
			givenPkgName:         "spaghetti-analyzer",
			expectedRelPkg:       "/",
			expectedStrictRelPkg: "",
		}, {
			name:                 "standard-package",
			givenPkgPath:         "github.com/flowdev/spaghetti-analyzer/x/config",
			givenPkgName:         "config",
			expectedRelPkg:       "x/config",
			expectedStrictRelPkg: "",
		}, {
			name:                 "test-package",
			givenPkgPath:         "github.com/flowdev/spaghetti-analyzer/x/config_test",
			givenPkgName:         "config_test",
			expectedRelPkg:       "x/config_test",
			expectedStrictRelPkg: "",
		}, {
			name:                 "test-package-2",
			givenPkgPath:         "github.com/flowdev/spaghetti-analyzer/x/config.test",
